...
<%@ page import="com.model.Caramelos"%>
          ...
          <% HttpSession sesionoscar = request.getSession();
          		...
          		Reyes reyes=(Reyes) sesionoscar.getAttribute("usuarionormal");
          		 if (sesionoscar.getAttribute("usuarionormal") !=null){
                 	...
                 	out.print("<h1 id='color'>Listado de tipos de caramelos en cada pabellón y su cantidad</h1>");
                 	out.print("<table class='table table-striped'>");
                 	out.print("<thead class='table-dark'>");
                 	out.print("<tr>");
                 	out.print("<th>Pabellón</th>");
                 	out.print("<th>Sandia</th>");
                 	out.print("<th>Menta</th>");
                 	out.print("<th>Fresa</th>");
                 	out.print("</tr>");
                 	out.print("</thead>");
                 	out.print("<tbody>");
                 	out.print("");
                 	%>
                 	<%
					LinkedList<Caramelos> lista = Controller.getCaramelos();
					...
					out.println("<td>" + lista.get(i).getSandia() + "</td>");
					out.println("<td>" + lista.get(i).getMenta() + "</td>");
					out.println("<td>" + lista.get(i).getFresa() + "</td>");
					}
					out.println("</tr>");
					%>
					<%
                 	...
                 	out.print("<input type='text' class='form-control' name='pabellons' required >");
                 	out.print("</div>");
                 	out.print("<div class='input-group mb-4'>");
                 	out.print("<span class='input-group-text'>Sandia</span>");
                 	out.print("<input type='text' class='form-control' name='sandia' required pattern='[0-9]{1,10}'>");
                 	out.print("</div>");
                 	out.print("<div class='input-group mb-3'>");
                 	out.print("<span class='input-group-text'>Menta</span>");
                 	out.print("<input type='text' class='form-control' name='menta' required pattern='[0-9]{1,10}'>");
                 	out.print("</div>");
                 	out.print("<div class='input-group mb-3'>");
                 	out.print("<span class='input-group-text'>Fresa</span>");
                 	out.print("<input type='text' class='form-control' name='fresa' required pattern='[0-9]{1,10}'>");
                 	out.print("</div>");
                 	out.print("<div class='text-center'>");
                 	out.print("<a href='listadoCaramelos.jsp'><button type='Submit' class='btn btn-dark'>Añadir</button></a>");
                 	out.print("</div>");
                 	out.print("</div>");
                 	out.print("</form>");
                 	out.print("");
